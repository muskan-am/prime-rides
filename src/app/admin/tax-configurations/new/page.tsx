...
export default function NewTaxConfigurationPage() {
  ...
  const handleSubmit = async (
    ...
    if (!trimmedName) {
      setError("Tax configuration name is required.");
      return;
    }
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Something went wrong while creating tax configuration."
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Create a tax configuration for new bookings.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Enter a name such as GST or Rental Tax.
              </p>
            </div>
