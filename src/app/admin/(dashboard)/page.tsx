    ...
    <div className="space-y-8">
      ...
      <div className="rounded-2xl bg-white border border-slate-200 shadow-sm overflow-hidden">
        <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h2 className="text-base sm:text-lg font-bold text-slate-900">Recent Reservations</h2>
        ...
        {recentBookings.length === 0 ? (
          ...
          <>
            {/* Mobile Card List View (visible on mobile < 640px) */}
                ...
                return (
                  <div key={b.id} className="p-4 space-y-3 bg-white">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <p className="font-bold text-sm text-slate-900">{b.user?.name || "Guest Customer"}</p>
                        <p className="text-xs text-slate-500">{b.user?.email || "N/A"}</p>
                      </div>
                      <span
                    ...
                    <div className="flex items-center justify-between text-xs pt-1 border-t border-slate-50">
                      <div>
                        ...
                        <span className="font-bold text-slate-800">{b.vehicle?.brand} {b.vehicle?.model}</span>
                      </div>
                      <span className="font-mono text-slate-500 text-[11px]">{b.vehicle?.registrationNumber || ""}</span>
                    </div>
                    ...
                    <div className="pt-1 text-right">
                      <Link
                        ...
                        className="inline-flex w-full items-center justify-center px-3 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-xs font-bold text-slate-800 transition-colors"
                      >
                        Manage Reservation
                      </Link>
                    </div>
            ...
            {/* Desktop / Tablet Table View (visible on sm >= 640px) */}
